		...
		<section class="post-fluid">
			<div class="container-fluid">
				<div class="row archive-banner">
					...
					<p class="lead about-lead">Go back into time and read all the articles we ever had to show you here on our web.</p>
										...
										<div class="media clearfix">
											...
											<div class="media-body">
												...
												<div class="article-info">
													...
													<a href="{{ URL('/article/'.$article->id) }}">{{ $article->comments->count() }} comments</a>
												</div>
											</div>
										</div>
									</li>
