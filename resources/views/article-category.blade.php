									...
									<div class="col-md-12">
										<div class="post-item">
											<div class="post-item-paragraph">
												...
												<div>
													{!! textShorten($article->description) !!}
				...
				<aside class="col-md-4">
					...
					<div class="laread-right">
						...
						<ul class="laread-list">
							...
							<li class="@if( $category->id == $article_category->id ) active @endif"><a href="{{ URL('/article/category/'.$category->id) }}">{{ $category->title }} ({{ $category->articles->count() }})</a><i class="line"></i></li>
							@endforeach
						</ul>
