    ...
    <div id="editModal-{{ $row->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
              <form class="needs-validation" novalidate action="{{ URL::route($url.'.update', $row->id) }}" method="post">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Customer Name" value="{{$row->name}}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote" name="details" id="details" rows="8">{{$row->address}}</textarea>
                    </div>
                    <!-- Form End -->
                </div>
